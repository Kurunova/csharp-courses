...
// class Result
// {
// 	public static int Execute(string word, List<string> dict)
// 	{
// 		int maxWordIndex = 0;
...
// 			dict.Add(data);
// 			hashTable.Add(data.Substring(data.Length - 2, 1), data);
// 			var r = hashTable[]
// 		}
// 		
...
// 		{
// 			var data = Console.ReadLine().TrimEnd();
// 			int result = Result.Execute(data, dict);
// 			results.Add(result);
// 		}
// 		
// 		foreach (var result in results)
// 		{
// 			Console.WriteLine(dict[result]);
// 		}
// 	}
// }