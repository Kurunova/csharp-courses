...
";
    ...
    private static Payment ToDomainObject(PaymentDao dao)
        => new()
        {
            ...
            Status = (PaymentStatus)dao.Status,
            ProviderPaymentId = dao.ProviderPaymentId,
            BankCard = dao.BankCardFirst6 != null && dao.BankCardLast4 != null
                ? new CardInfo(
                    first6: dao.BankCardFirst6,
                    last4: dao.BankCardLast4,
                    expirationMonth: dao.BankCardExpirationMonth,
                    expirationYear: dao.BankCardExpirationYear)
                : null,
        };
}
