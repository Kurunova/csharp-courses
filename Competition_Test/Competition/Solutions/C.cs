...
// class Result
// {
// 	public static string Execute(List<int> data)
// 	{
// 		List<KeyValuePair<int, int>> keyValuePairs = data.Select((x, index) => new { index = index + 1, value = x })
...
// 		
// 		int counter = 1;
// 		var length = keyValuePairs.Count / 2;
//
...
// 				if (j == 1)
// 				{
// 					minDistance = Math.Abs(keyValuePairs[0].Value - keyValuePairs[j].Value);
// 					minIndex = j;
// 				}
// 				
// 				var newDistance = Math.Abs(keyValuePairs[0].Value - keyValuePairs[j].Value);
...
// 			}
//
// 			result += $"{keyValuePairs[0].Key} {keyValuePairs[minIndex].Key}{Environment.NewLine}";
// 			keyValuePairs.RemoveAt(0);
// 			keyValuePairs.RemoveAt(minIndex-1);
// 		}
// 		
//
// 		return result;
...
// 			string result = Result.Execute(data);
// 			results.Add(result);
// 		}
//
